...
Potentiaalikenttiä käytetään myös robottimanipulaattoreilla, mutta ne soveltuvat liikkuvillekin roboteille. \cite{warren2002apf}


\cite{vadakkepat2002eapf}
...
Tämä tapa soveltuu erityisesti häiriöiseen ja epävarmaan mittaukseen, ja sitä onkin testattu ultraäänisensoreilla joihin liittyy lähes ominaisesti tietynlaista häiriötä.
...
\cite{glasius1995neural} \cite{yang2000neural}
