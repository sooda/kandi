...
VFH+:sta vielä edelleen kehitetty VFH* käyttää A*-hakualgoritmia etsimään oikean valinnan saman laatuisista poluista, ja näkee täten hieman kauemmas. VFH+ itsessään on täysin lokaali, ja saattaa väistää estettä umpikujaa päin, vaikka toiseen suuntaan väistäessä ei päädyttäisi umpikujaan. \cite{ulrich2002vfhstar} (Jatkoa seuraa...)
